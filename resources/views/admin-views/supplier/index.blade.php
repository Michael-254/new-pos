    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col-sm mb-2 mb-sm-0">
                <h1 class="page-header-title text-capitalize"><i class="tio-add-circle-outlined"></i> {{\App\CPU\translate('add_new_supplier')}}
                </h1>
            </div>
        </div>
    </div>
                        ...
                        <div class="row pl-2">
                            <div class="col-12 col-md-12">
                                ...
                                <div class="form-group">
                                    <hr>
                                    <center>
                                        <img class="img-one-si" id="viewer" src="{{asset('assets/admin/img/400x400/img2.jpg')}}" alt="image" />
                                    </center>
                                </div>
                            </div>
                        </div>
