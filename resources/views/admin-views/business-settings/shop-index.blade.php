                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-lg-6 mb-3 mb-lg-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="shop_address" value="{{ $shop_address }}" class="form-control" placeholder="{{ \App\CPU\translate('shop_address') }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-5 col-lg-5 mb-3 mb-lg-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="footer_text" value="{{ $footer_text }}" class="form-control" placeholder="{{ \App\CPU\translate('footer_text') }}" required>
                                </div>
                            </div>
                            <div class="col-sm-4 col-lg-4 mb-3 mb-lg-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="stock_limit" value="{{ $stock_limit }}" class="form-control" placeholder="{{ \App\CPU\translate('stock_limit') }}" required>
                                </div>
                            </div>
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-lg-6 mb-3 mb-lg-2">
                                <div class="form-group ">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" name="shop_logo" id="customFileEg1" class="custom-file-input" accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                        <label class="custom-file-label" for="customFileEg1">{{ \App\CPU\translate('choose') }}
                                            {{ \App\CPU\translate('file') }}</label>
                                    </div>
                                    <hr>
                                    <center>
                                        <img class="img-one-bs" id="viewer" onerror="this.src='{{ asset('public/assets/admin/img/160x160/img2.jpg') }}'" src="{{ asset('storage/app/public/shop/' . $shop_logo) }}" alt="" />
                                    </center>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-lg-6 mb-3 mb-lg-2">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control" type="text" name="vat_reg_no" placeholder="{{ \App\CPU\translate('vat_reg_no') }}" value="{{ $vat_reg_no }}">
                                </div>
                            </div>
                        </div>
                        <hr>
                        <button type="submit" class="btn btn-primary mb-2">{{ \App\CPU\translate('submit') }}</button>
                    </form>
                </div>
            </div>
        </div>
