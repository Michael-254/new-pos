            ...
            <div class="col-sm mb-2 mb-sm-0">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-no-gutter">
                        ...
                        <li class="breadcrumb-item active text-capitalize" aria-current="page">{{\App\CPU\translate('customer_details')}}</li>
                    </ol>
                        ...
                        <div class="col-12 col-sm-8 col-md-4 col-lg-6">
                            <form action="{{url()->current()}}" method="GET">
                                ...
                                <div class="input-group input-group-merge input-group-flush">
                                    ...
                                    <input id="datatableSearch_" type="search" name="search" class="form-control" placeholder="{{\App\CPU\translate('search_by_order_id')}}" aria-label="Search" value="{{ $search }}" required>
                ...
                <div class="card-body">
                    <div class="media align-items-center" href="javascript:">
                        <div class="avatar avatar-circle mr-3">
                            <img class="avatar-img" onerror="this.src='{{asset('assets/admin/img/160x160/img1.jpg')}}'" src="{{asset('storage/app/public/customer/'.$customer->image)}}" alt="Image Description">
                        </div>
                    ...
                    @if ($customer->is_loyalty_enrolled == 'Yes')
                        <div class="media align-items-center mt-1" href="javascript:">
                            ...
                            <div class="media-body">
                                <span class="text-body text-hover-primary">{{$customer->loyalty_points}}  Loyalty Points</span>
                            </div>
                        </div>
                    @endif
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body row font-one-cv">
                <div class="col-md-12">
                    <center>
                        <input type="button" class="btn btn-primary non-printable" onclick="printDiv('printableArea')" value="{{\App\CPU\translate('Proceed, If thermal printer is ready')}}." />
