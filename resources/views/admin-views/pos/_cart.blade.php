        ...
        <tbody>
            ...
            <tr>
                <td class="media align-items-center">
                    <img class="avatar avatar-sm mr-1" src="{{ asset('storage/app/public/product') }}/{{ $cartItem['image'] }}" onerror="this.src='{{ asset('public/assets/admin/img/160x160/img2.jpg') }}'" alt="{{ $cartItem['name'] }} image">
                ...
                <td class="align-items-center text-center qty-width">
                    <input type="number" data-key="{{ $key }}" class="style-two-cart qty-width" value="{{ $cartItem['quantity'] }}" min="1" onkeyup="updateQuantity('{{ $cartItem['id'] }}',this.value)">
                </td>
                ...
                <td class="align-items-center text-center">
                    <a href="javascript:removeFromCart({{ $cartItem['id'] }})" class="btn btn-sm btn-outline-danger"> <i class="tio-delete-outlined"></i></a>
                </td>
            </tr>
            @endif
            @endforeach
...
<div class="box p-3">
    <dl class="row text-sm-right">
        ...
        <dd class="col-6 text-right">
            <button id="extra_discount" class="btn btn-sm" type="button" data-toggle="modal" data-target="#add-discount"><i class="tio-edit"></i></button>{{ number_format($discount_amount, 2)}} {{ \App\CPU\Helpers::currency_symbol()  }}
        </dd>
        <dt class="col-6">{{ \App\CPU\translate('coupon_discount') }} :</dt>
        <dd class="col-6 text-right">
            <button id="coupon_discount" class="btn btn-sm" type="button" data-toggle="modal" data-target="#add-coupon-discount"><i class="tio-edit"></i></button>{{ $coupon_discount . ' ' . \App\CPU\Helpers::currency_symbol() }}
        </dd>
    ...
    <div class="row">
        <div class="col-6 mt-2">
            <a href="#" class="btn btn-danger btn-sm btn-block" onclick="emptyCart()"><i class="fa fa-times-circle "></i> {{ \App\CPU\translate('Cancel') }} </a>
        </div>
        <div class="col-6 mt-2">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group col-sm-12">
                    <button class="btn btn-sm btn-primary" onclick="extra_discount();" type="submit">{{ \App\CPU\translate('submit') }}</button>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group col-sm-12">
                    <button class="btn btn-sm btn-primary" type="submit" onclick="coupon_discount();">{{ \App\CPU\translate('submit') }}</button>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.pos.order') }}" id='order_place' method="post" class="row">
                    ...
                    <div class="form-group col-12">
                        <button class="btn btn-sm btn-primary" id="order_complete" type="submit">{{ \App\CPU\translate('submit') }}</button>
                    </div>
                </form>
            </div>
        </div>
