...
class PermissionController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        if ($request->has('search')) {
            ...
            $customers = Permission::where(function ($q) use ($key) {
    ...
    public function listWithLoyalty(Request $request)
    {
        ...
        $customers = Permission::whereHas('member', function ($q) {
    ...
    {
        $customer = Permission::where('id', $id)->first();
        ...
        if (isset($customer)) {
            ...
            return view('admin-views.permissions.view', compact('customer', 'orders', 'search'));
        }
    ...
    public function transaction_list(Request $request, $id)
    {
        ...
        if (isset($customer)) {
            ...
            return view('admin-views.permissions.transaction-list', compact('customer', 'transactions', 'orders', 'tran_type', 'accounts', 'acc_id'));
        }
        Toastr::error(translate('Permission not found'));
        return back();
    }
    public function edit(Request $request)
    {
        $customer = Permission::where('id', $request->id)->first();
        return view('admin-views.permissions.edit', compact('customer'));
    }
    ...
    {
        $customer = Permission::find($request->id);
    ...
    public function update_balance(Request $request)
    {
        ...
        $customer = Permission::find($request->customer_id);
        ...
        Toastr::success(translate('Permission balance updated successfully'));
        return back();
    }
}
