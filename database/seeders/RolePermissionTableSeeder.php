...
class RolePermissionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // create permissions
        Permission::create(['name' => 'edit users', 'guard_name' => 'admin', 'company_id' => 1]);
        Permission::create(['name' => 'delete users', 'guard_name' => 'admin', 'company_id' => 1]);
        Permission::create(['name' => 'create users', 'guard_name' => 'admin', 'company_id' => 1]);
        Permission::create(['name' => 'list users', 'guard_name' => 'admin', 'company_id' => 1]);
