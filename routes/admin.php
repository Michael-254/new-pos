...
Route::group(['namespace'=>'Admin', 'as' => 'admin.', 'prefix'=>'admin'] ,function(){
    ...
    Route::group(['middleware' => ['admin']], function(){
        ...
        //business settings
        Route::group(['prefix' => 'companies', 'as' => 'companies.','middleware'=>['actch']], function () {
            Route::get('all', 'CompaniesController@index')->name('shops');
            Route::get('shop-setup', 'CompaniesController@shop_index')->name('shop-setup');
            Route::post('update-setup', 'CompaniesController@shop_setup')->name('update-setup');
            Route::get('shortcut-keys', 'CompaniesController@shortcut_key')->name('shortcut-keys');
        });
        //business settings
